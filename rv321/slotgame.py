...
for i in range(10):
    program.add(Inst.ADDI(seg_pattern, 0, list_seg_patterns[i]))
    program.add(Inst.SB(seg_patterns_mem, seg_pattern, i))
    program.add(Inst.SB(seg_patterns_mem, seg_pattern, i + 1))  # dummySB
